                        ...
                        <div className="flex items-center space-x-2">
                         ...
                         <div className="flex flex-col space-y-2 overflow-auto">
                            ...
                            <ul className="flex flex-col space-y-2">
                                <li className="rounded-lg p-2 bg-gray-600">Send you a message with the phone number: +1 (757) 835-3913 at 10pm in the time zone you specify.</li>
                                <li className="rounded-lg p-2 bg-gray-600">That{"'"}s it, it{"'"}s pretty simple.</li>
                            </ul>
                        </div>
                    </div>
                </div>
